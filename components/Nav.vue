<template>
  <nav dir="rtl" class="fixed w-full z-30 p-6 bg-white shadow-md">
    <div class="flex items-center justify-between">
      ...
      <div>
        <a href="#">
          <img
            ...
            src="/assets/image/Logo_Header.svg"
            alt="logo"
        /></a>
      </div>
      ...
      <div class="hidden md:block">
        <ul class="flex gap-2 md:text-lg text-sm">
          <li class="button01">
            <a href="#">عضویت</a>
          </li>
          <li class="button01">
      ...
      <!-- Drawer Menu -->
      <aside
        class="p-5 transform top-0 right-0 w-64 bg-white fixed h-full overflow-auto ease-in-out transition-all duration-300 z-30"
      ...
      >
        ...
        <ul class="divide-y">
          ...
          <li class="button01">
            <a href="#" @click="isOpen = false" class="mt-8">عضویت</a>
          </li>
          <li class="button01">
            <a href="#" @click="isOpen = false" class="mt-4 mb-8">ورود</a>
          </li>
        </ul>

        <div class="follow">
          <p class="italic text-sm">ارتباط با ما:</p>
